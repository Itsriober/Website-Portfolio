...
const WORDS = ["Full-Stack Developer", "Graphic Designer", "Tech Enthusiast"];
const TECH_STACK = ["HTML & CSS","PHP", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Itsriober" },
  { icon: Facebook, link: "https://web.facebook.com/itsriober" },
  { icon: Instagram, link: "https://www.instagram.com/itsriober/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Creating innovative, functional, and user-friendly websites through full-stack development & Cloud expertise.
                </p>
