...
const socialLinks = [
  {
    ...
    subText: "on Github",
    icon: Github,
    url: "https://github.com/Itsriober",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@itsriober",
    icon: Instagram,
    url: "https://www.instagram.com/itsriober/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@itsriober",
    icon: Facebook,
    url: "https://web.facebook.com/itsriober",
    color: "#0A66C2",
    gradient: "from-[#0A66C2] to-[#0077B5]",
  },
  {
...
const SocialLinks = () => {
  ...
  const [instagram, facebook, email, tiktok] = otherLinks;
